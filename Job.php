...
{
include('connection.php');
 $query="SELECT customer2.cust_name,customer2.phone,customer2.address,customer2.interested, customer2.pincode,customer2.remarks,calling2.time_from,calling2.time_to,calling2.assigned_to FROM customer2 INNER JOIN calling2 ON customer2.id=calling2.customer_id
 ORDER BY calling2.id DESC";
...
<body>
  ...
  <a href="../Job/logout3.php"><input type="button" style="background-color: green;" name="" value="Logout" class="btn btn-success" style="cursor: pointer"></a>
   </div>
<?php 
