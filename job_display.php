...
<body>
  ...
  <a href="../Job/logout3.php"><input type="button" style="background-color: green background-color: green;
    margin-left: 948px;
    float: right;
    width: 163px;
    " name="" value="Logout" class="btn btn-success" style="cursor: pointer"></a>
   </div>
...
<center>
<table class="table table-structured table-bordered table-responsive " style="width:737px;margin-top: 41px;" id="table1">
     ...
     <tr class="table-primary"><th>Remarks:</th><td><?php echo $row['remark'];?></td></tr> 
     <tr class="table-primary"><th>Schedule:</th><td><?php echo $row['schedule'];?></td></tr> 
     ...
     <tr class="table-primary"><th>Time To:</th><td><?php echo $row['time_to'];?></td></tr>
        ...
        <a href="start_time_update.php?auto_id=<?php echo $row['auto_id'];?>"><button class="custom-btn btn-15" type="button"><i class="fa fa-home" aria-hidden="true" style="font-size:red;padding: 2px;"></i>Start</button></a>
      
      <a href="insert_job.php?auto_id=<?php echo $row['auto_id'];?>"><button class="custom-btn btn-13" id="success" name="sub" ><i class="fas fa-info-circle" aria-hidden="true" style="font-size:red;padding: 8px";></i> </i>Hold</button></a>

      <a href="end_time_update.php?auto_id=<?php echo $row['auto_id'];?>"><button class="custom-btn btn-14"> <i class="fa fa-trash" aria-hidden="true" style="font-size:red;padding: 8px;"></i>End</button></a> 
